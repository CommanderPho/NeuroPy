...
class SpikesAccessor(TimeSlicedMixin, TimePointEventAccessor):
    ...
    def get_split_by_unit(self, included_neuron_ids=...) -> List[pd.DataFrame]:
    ...
    def get_unit_spiketrains(self, included_neuron_ids=...) -> NDArray:
    ...
    def add_binned_time_column(self, time_window_edges: NDArray, time_window_edges_binning_info: BinningInfo, debug_print: bool = ...): # -> Any:
        """ adds a 'binned_time' column to spikes_df given the time_window_edges and time_window_edges_binning_info provided 
        
        """
        ...
    
    def compute_unit_time_binned_spike_counts(self, time_bin_edges: NDArray, included_neuron_ids: Optional[NDArray[ND.Shape[N_ACLUS], ND.Int]] = ...) -> Tuple[NDArray[ND.Shape["N_ACLUS, N_TIME_BINS"], ND.Int], NDArray[ND.Shape[N_ACLUS], ND.Int]]:
    ...
    def compute_unit_time_binned_spike_counts_and_mask(self, time_bin_edges: NDArray[ND.Shape[N_TIME_BINS], Any], included_neuron_ids: Optional[NDArray[ND.Shape[N_ACLUS], ND.Int]] = ..., min_num_spikes_per_bin_to_be_considered_active: int = ..., min_num_unique_active_neurons_per_time_bin: int = ...) -> Tuple[NDArray[ND.Shape["N_ACLUS, N_TIME_BINS"], ND.Int], NDArray[ND.Shape[N_ACLUS], ND.Int], Tuple[NDArray[ND.Shape[N_TIME_BINS], Any], NDArray[ND.Shape[N_TIME_BINS], Any], NDArray[ND.Shape["1, N_TIME_BINS, 4"], np.uint8]]]:
        """ Computes the number of neurons in each spike time bin (specified by time_bin_edges) and threshold based on some criteria
