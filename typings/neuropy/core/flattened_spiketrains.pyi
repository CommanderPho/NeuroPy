...
class SpikesAccessor(TimeSlicedMixin, TimePointEventAccessor):
    ...
    def compute_unit_time_binned_spike_counts_and_mask(self, time_bin_edges: NDArray, min_num_spikes_per_bin_to_be_considered_active: int = ..., min_num_unique_active_neurons_per_time_bin: int = ...) -> Tuple[NDArray, Tuple[NDArray, NDArray, NDArray]]:
