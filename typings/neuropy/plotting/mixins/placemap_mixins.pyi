...
class PfnD_PlotOccupancy_Mixin:
    ...
    def plot_occupancy(self, identifier_details_list=..., fig=..., ax=..., active_context=..., use_flexitext_titles: bool = ..., skip_update_titles: bool = ..., plot_pos_bin_axes: bool = ..., **kwargs): # -> tuple[Figure | Any, Axes | Any]:
