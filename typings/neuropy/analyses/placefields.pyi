...
class PfnDMixin(SimplePrintable):
    ...
    @safely_accepts_kwargs
    def plotRaw_v_time(self, cellind, speed_thresh=..., spikes_color=..., spikes_alpha=..., ax=..., position_plot_kwargs=..., spike_plot_kwargs=..., should_include_trajectory=..., should_include_spikes=..., should_include_filter_excluded_spikes=..., should_include_labels=..., use_filtered_positions=..., use_pandas_plotting=...): # -> list[Any] | Any:
...
class PfND(HDFMixin, AttrsBasedClassHelperMixin, ContinuousPeakLocationRepresentingMixin, PeakLocationRepresentingMixin, NeuronUnitSlicableObjectProtocol, BinnedPositionsMixin, PfnConfigMixin, PfnDMixin, PfnDPlottingMixin):
    ...
    def setup(self, position: Position, spikes_df: pd.DataFrame, epochs: Epoch, debug_print=...): # -> None:
