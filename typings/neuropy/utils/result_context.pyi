...
class ContextFormatRenderingFn(Protocol):
    ...
    """
    def __call__(self, ctxt: DisplaySpecifyingIdentifyingContext, subset_includelist: Optional[List[str]] = ..., subset_excludelist: Optional[List[str]] = ...) -> str:
        ...
    
    @classmethod
    def no_op(cls, ctxt: DisplaySpecifyingIdentifyingContext, subset_includelist: Optional[List[str]] = ..., subset_excludelist: Optional[List[str]] = ...) -> str:
        """ does nothing """
        ...
...
class DisplaySpecifyingIdentifyingContext(IdentifyingContext):
    ...
    """
    display_dict: Dict = ...
    specific_purpose_display_dict: Dict[str, ContextFormatRenderingFn] = ...
    def __init__(self, display_dict=..., specific_purpose_display_dict=..., **kwargs) -> None:
        ...
    ...
    @classmethod
    def resolve_key(cls, duplicate_ctxt: DisplaySpecifyingIdentifyingContext, name: str, value, collision_prefix: str, strategy: CollisionOutcome = ...): # -> str | None:
        """ensures no collision between attributes occur, and if they do resolve them according to strategy. e.g. rename them with an identifying prefix
        Returns the resolved key (str) or None.
        """
        ...
