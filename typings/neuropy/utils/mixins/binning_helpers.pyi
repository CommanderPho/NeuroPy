...
from neuropy.utils.mixins.AttrsClassHelpers import AttrsBasedClassHelperMixin, SimpleFieldSizesReprMixin, custom_define, serialized_attribute_field
...
class DebugBinningInfo(HDF_SerializationMixin, AttrsBasedClassHelperMixin):
    ...
    n_ybin_edges: int = ...
    ndim: int = ...
    nFlatPositionBins: int = ...
    nCells: Optional[int] = ...
    nTimeBins: Optional[int] = ...
    @property
...
def safe_limit_num_grid_bin_values(fixed_grid_bin_bounds: Tuple[Tuple[float, float], Tuple[float, float]], desired_grid_bin_sizes: Tuple[float, float], max_allowed_num_bins: Optional[Tuple[int, int]] = ..., debug_print: bool = ...) -> Tuple[Tuple[float, float], Tuple[int, int]]:
    """ 
