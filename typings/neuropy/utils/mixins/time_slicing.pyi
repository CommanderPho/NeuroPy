...
class TimePointEventAccessor(TimeColumnAliasesProtocol, TimeSlicableObjectProtocol):
    ...
    def add_binned_time_column(self, time_window_edges, time_window_edges_binning_info: BinningInfo, override_time_variable_name=..., debug_print: bool = ...): # -> DataFrame[Any]:
        """ adds a 'binned_time' column to spikes_df given the time_window_edges and time_window_edges_binning_info provided 
        
        """
        ...
    
    def adding_epochs_identity_column(self, epochs_df: pd.DataFrame, epoch_id_key_name: str = ..., epoch_label_column_name=..., override_time_variable_name=..., no_interval_fill_value=..., should_replace_existing_column=..., drop_non_epoch_events: bool = ..., overlap_behavior: OverlappingIntervalsFallbackBehavior = ...): # -> DataFrame[Any]:
    ...
    def adding_lap_identity_column(self, laps_epoch_df, epoch_id_key_name: str = ..., override_time_variable_name=...): # -> DataFrame[Any]:
    ...
    @classmethod
    def add_maze_id_if_needed(cls, active_point_events_df: pd.DataFrame, t_start: float, t_delta: float, t_end: float, replace_existing: bool = ..., event_time_col_name: str = ...) -> pd.DataFrame:
    ...
    def adding_maze_id_if_needed(self, t_start: float, t_delta: float, t_end: float, replace_existing: bool = ..., override_time_variable_name=...) -> pd.DataFrame:
        """ 2024-01-17 - adds the 'maze_id' column if it doesn't exist
    ...
    def adding_true_decoder_identifier(self, t_start: float, t_delta: float, t_end: float, replace_existing: bool = ..., override_time_variable_name=...) -> pd.DataFrame:
        """ 2024-01-17 - adds the 'maze_id' column if it doesn't exist
