...
class UserAnnotationsManager(HDFMixin, AttrsBasedClassHelperMixin):
    ...
    def get_hardcoded_specific_session_override_dict(cls) -> dict:
        ...
        # ---------------------------------------------------------------------------- #
        #          2024-04-10 - Added Grid Bin Bounds from Kamrna's .mat files         #
        # ---------------------------------------------------------------------------- #
        ...
        # ==================================================================================================================================================================================================================================================================================== #
        ### !!! 2025-01-17 20:23 This is NOT USED. The entries must exist to be updated, all of them are overwritten
        ...
        _included_contexts: List[IdentifyingContext] = [
        ...
        for a_ctxt in _included_contexts:
            if a_ctxt not in user_annotations:
                user_annotations[a_ctxt] = dict() ## new dict
            a_dict = user_annotations[a_ctxt] ## return the dict for modifications            
            ...
            a_dict.update(pix2cm=pix2cm, real_unit_grid_bin_bounds=(tuple(deepcopy(real_unit_x_grid_bin_bounds)), tuple(deepcopy(real_unit_y_grid_bin_bounds))),
                                         real_cm_grid_bin_bounds=(tuple(deepcopy(real_cm_x_grid_bin_bounds)), tuple(deepcopy(real_cm_y_grid_bin_bounds))))
            a_dict.update(grid_bin_bounds=a_dict['real_cm_grid_bin_bounds'])            
