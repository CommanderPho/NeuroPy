...
class UserAnnotationsManager(HDFMixin, AttrsBasedClassHelperMixin):
    ...
    def get_hardcoded_good_sessions(cls) -> List[IdentifyingContext]:
        ...
        good_sessions = [
            ...
            IdentifyingContext(format_name='kdiba',animal='gor01',exper_name='two',session_name='2006-6-12_16-53-46'),
            IdentifyingContext(format_name='kdiba',animal='gor01',exper_name='one',session_name='2006-6-13_14-42-6'), ## #TODO 2025-11-03 11:17: - [ ] NEW
            ...
            IdentifyingContext(format_name='kdiba',animal='pin01',exper_name='one',session_name='fet11-04_21-20-3'),  ## #TODO 2025-11-03 11:17: - [ ] NEW
